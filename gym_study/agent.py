...
class DQNAgent(object):
    ...
    def train(self, env: Env, nb_episodes: int = 100, nb_warmup_steps: int = 200, nb_steps_per_episode: int = 500, \
        ...
        for i_episode in range(1, nb_episodes+1):
            ...
            # for t = 1, T do
            for t in range(1, nb_steps_per_episode+1):
                if render_mode:
                    env.render()
    ...
    def play(self, env: Env, nb_episodes: int = 10, render_mode: bool = True, weight_filename: str = None):
        ...
        for i_episode in range(1, nb_episodes+1):
            ...
            while True:
                ...
                if done:
                    logging.info('Play Episode: %d|%d, Reward: %d' % (i_episode, nb_episodes, reward))
                    time.sleep(1)
                    break
